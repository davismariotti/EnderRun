                ...
                for (int x=0; x<16; x++) {
                        for (int z=0; z<16; z++) {
                                ...
                                for (int y=64;y<128;y++) {
                                        double density = gen1.noise(realX,y, realZ, 1, 1); //note 3d noise is VERY slow, I recommend using 2d noise to limit the number of 3d noise values that must be calculated.
